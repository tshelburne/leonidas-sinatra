...
(function() {
  ...
  Environment = (function() {
    ...
    Environment.prototype.addUrl = function(key, path) {
      return this.urls[key] = path;
    };

    Environment.prototype.url = function(key) {
  ...
  (typeof exports !== "undefined" && exports !== null ? exports : this).environment = new Environment();

}).call(this);

  };
  modules.__environment = function() {
    if (environmentCache === null) {
      environmentCache = environmentFunc();
    }
...
(function() {
  var modules = window.modules || [];
  var increment_handlerCache = null;
  var increment_handlerFunc = function() {
    return (function() {
  var IncrementHandler;

  IncrementHandler = (function() {
    function IncrementHandler(state) {
      this.state = state;
    }

    IncrementHandler.prototype.handles = function(command) {
      return command.name === "increment";
    };

    IncrementHandler.prototype.run = function(command) {
  ...
  modules.handlers__increment_handler = function() {
    if (increment_handlerCache === null) {
      increment_handlerCache = increment_handlerFunc();
    }
    return increment_handlerCache;
  };
  window.modules = modules;
})();
...
(function() {
  var modules = window.modules || [];
  var log_handlerCache = null;
  var log_handlerFunc = function() {
    return (function() {
  var LogHandler;
  ...
  LogHandler = (function() {
    ...
    LogHandler.prototype.handles = function(command) {
      return command.name === "log";
    };

    LogHandler.prototype.run = function(command) {
      return console.log("" + command.data.message + " at " + command.timestamp);
    };
  ...
  modules.handlers__log_handler = function() {
    if (log_handlerCache === null) {
...
(function() {
  var modules = window.modules || [];
  var patchesCache = null;
  var patchesFunc = function() {
    return (function() {
  ...
  modules.__patches = function() {
    if (patchesCache === null) {
      patchesCache = patchesFunc();
    }
    return patchesCache;
  };
  window.modules = modules;
